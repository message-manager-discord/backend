/*
  ...
  - The values [warning] on the enum `ReportStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ReportStatus_new" AS ENUM ('pending', 'assigned', 'review', 'spam', 'actioned', 'invalid');
